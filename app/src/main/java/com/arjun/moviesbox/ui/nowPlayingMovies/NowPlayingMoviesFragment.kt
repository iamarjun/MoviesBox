...
import com.arjun.moviesbox.databinding.NowPlayingMoviesFragmentBinding
...
class NowPlayingMoviesFragment : Fragment() {
    ...
    private val binding: NowPlayingMoviesFragmentBinding by viewBinding(
        NowPlayingMoviesFragmentBinding::bind
    )
